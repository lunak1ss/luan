...
//  页面内容说明
// ═══════════════════════════════════════════
//  页面内容直接使用下方内置数据（projects / mediaItems 等），
//  不再依赖运行时 API，保证在 Netlify 等静态托管上也完整渲染。
//  修改内容请编辑本文件对应数据区，而不是 data/*.json（JSON 仅供后台管理页本地使用）。
...
const mediaItems: MediaItem[] = [
  // ═══ 海报/图片作品 ═══
  {
    ...
    title: "挑战杯项目海报",
    type: "image",
    src: "/media/poster_challenge_cup.png",
    category: "宣传海报",
    description: "智能多栖：可变胞多模态飞行器 — 浙江省挑战杯金奖项目宣传海报",
    visible: true,
  },
  {
    id: "m2",
    title: "为你撑伞招募海报",
    type: "image",
    src: "/media/poster_umbrella_v2.png",
    category: "宣传海报",
    description: "为你撑伞成长支持项目 — 2026年暑期志愿者招募海报",
    visible: true,
  },
];
        ...
        <ScrollAnimation delay={100}>
          <div className="glass-card p-8 md:p-12">
            ...
            <div className="mt-10 pt-8 border-t border-[rgba(59,130,246,0.1)] text-center">
              <a
                href="/pdfs/郑一鸣-运营助理_专员.pdf"
                download="郑一鸣-运营助理_专员.pdf"
                className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-[#3B82F6] text-white text-sm font-medium hover:bg-[#2563EB] transition-all btn-glow"
              >
